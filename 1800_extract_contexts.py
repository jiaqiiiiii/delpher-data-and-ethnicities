...
base_dir = "/data/groups/trifecta/jiaqiz/downloaded_zip_delpher/kranten_pd_18xx"
window_size = 25  # 25 tokens before and after the target word
similarity_threshold = 0.7

def normalize_old_dutch_text(text):
    """Normalize 19th century Dutch text with OCR errors and spelling variations"""
    if not text:
        return ""
...
def main():
    ...
    for century in ["18xx"]:
        century_dir = base_dir.replace("18xx", century)
